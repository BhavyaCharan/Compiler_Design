...
headerFiles:HASH_INCL ID_HI				{$$ = newnode("headerFiles", 0, 2, $1, $2);}
	   ;
ID_HI:IDENTIFIER HASH_INCL_END				{$$ = newnode("ID_HI", 0, 2, $1, $2);}
	;
...
printf_statement: PRINTF '(' STRING ')'			{$$ = newnode("printf_statement", 0, 2, NULL, NULL);}
;

scanf_statement: SCANF '(' STRING ')'			{$$ = newnode("scanf_statement", 0, 2, NULL, NULL);}
;
